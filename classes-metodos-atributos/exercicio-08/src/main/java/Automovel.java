...
public class Automovel {
    ...
    public void Acelerar(String marcacarro) {
        System.out.println("O carro " + marcacarro + " acelerou");
    }

    public void Freiar(String marcacarro) {
        System.out.println("O carro " + marcacarro + " freiou");
    }

    public void Direita(String marcacarro) {
        System.out.println("O carro " + marcacarro + " se moveu para direita");
    }

    public void Esquerda(String marcacarro) {
        System.out.println("O carro " + marcacarro + " se moveu para esquerda");
    }
